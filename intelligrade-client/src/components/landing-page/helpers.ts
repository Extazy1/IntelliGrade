...
/**
 * Default data for the testimonials section
 */
export const defaultTestimonialsData = [
    {
        content: "IntelliGrade has transformed how we manage our examination process. The platform is intuitive and has significantly reduced our grading time.",
        author: "Dr. Sarah Johnson",
        role: "Department Head, University of Technology",
        avatar: "/avatars/avatar-1.png"
    },
    {
        content: "The analytics provided by IntelliGrade have given us valuable insights into student performance patterns that we never had access to before.",
